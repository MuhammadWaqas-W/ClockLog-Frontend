...
const UsersTable = (props: Props) => {
  ...
  const handleResendMessage = () => {
    props.tabsKey === "4" &&
      AppSnackbar({ type: "success", message: "Resend Successfully" });
  };
  ...
  const items: MenuProps["items"] = [
    ...
    },
    {
      label: (
        ...
        >
          <img src={Delete} alt="delete" height={18} width={16} />{" "}
          <span>Delete</span>
        </div>
      ),
      key: "2",
      ...
      columns.push({
        ...
        render: (src: string) => (
          <div className="d-flex align-center">
            <img src={Avatar} alt="" />
            <span style={{ marginLeft: "10px" }}>m waqas</span>
          </div>
        ),
      });
    IsShowTableColumns.includes("Email") &&
      columns.push({
        ...
        render: (src: string) => (
          <div className="d-flex align-center">
            <img src={Avatar} alt="" />
            <span style={{ marginLeft: "7px" }}>mr.vaqas@outlook.com</span>
          </div>
        ),
      });
