    ...
    <div className="invite-users">
            ...
            {systemInformation.map((val) => {
              return (
                <Col xs={24} md={9}>
                  ...
                  <p className="fs-14 title-color">{val.value}</p>
                </Col>
              );
            })}
          </Row>
      ...
      <Row style={{ gap: "20px", marginTop: "30px" }}>
        ...
        >
          ...
          <p className="fs-14 title-color">Assigned Project</p>{" "}
          <div
            className="projects"
            style={{
              display: "flex",
        ...
        >
          {" "}
          <h1 className="heading-color fs-20 fw-600">Team Information</h1>{" "}
          <>
            {" "}
            <p className="fs-14 title-color">Assigned Teams</p>{" "}
            <div
              className="projects"
              style={{
                display: "flex",
